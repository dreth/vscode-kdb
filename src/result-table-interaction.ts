...
export function headerPointerIntent(
  ...
  // Shift extends an existing whole-column selection only when the explicit
  // Ctrl/Cmd selection modifier is also held. Shift by itself remains a sort
  // click, matching ordinary table-header keyboard and pointer behavior.
